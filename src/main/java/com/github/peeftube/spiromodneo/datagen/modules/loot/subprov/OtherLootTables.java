...
public class OtherLootTables implements LootTableSubProvider
{
    ...
    public static final ResourceKey<LootTable> PIG_DROPS =
            ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.fromNamespaceAndPath(SpiroMod.MOD_ID, "mobs/pig_drops"));
    public static final ResourceKey<LootTable> SHEEP_DROPS =
            ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.fromNamespaceAndPath(SpiroMod.MOD_ID, "mobs/sheep_drops"));
    public static final ResourceKey<LootTable> COW_DROPS =
            ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.fromNamespaceAndPath(SpiroMod.MOD_ID, "mobs/cow_drops"));
