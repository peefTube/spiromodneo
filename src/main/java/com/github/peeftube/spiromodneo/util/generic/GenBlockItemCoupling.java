...
public record GenBlockItemCoupling(Supplier<Block> block, Supplier<Item> item)
{
    public static List<GenBlockItemCoupling> COUPLINGS = new ArrayList<>();

    public static GenBlockItemCoupling couple(Supplier<Block> b, Supplier<Item> i)
    { GenBlockItemCoupling c = new GenBlockItemCoupling(b, i); COUPLINGS.add(c); return c; }
    ...
    public static GenBlockItemCoupling createNewBasic(Supplier<Block> b)
    {
        ...
        return new GenBlockItemCoupling(b, i);
    }
    ...
    public static GenBlockItemCoupling findFromBlock(Supplier<Block> b)
    {
        ...
        { return new GenBlockItemCoupling(b, b0::asItem); }
        else
